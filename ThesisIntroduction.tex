...
\item The composition morphism \[c:\ubgMod(B,C) ⊗ \ubgMod(A,B) → \ubgMod(A,C)\] is defined in \Cref{weirdenrichment}.
...
\item The composition morphism $c : \utC(B,C)⊗\utC(A,B) → \utC(A,C)$ is defined in \Cref{weirdenrichment}.
