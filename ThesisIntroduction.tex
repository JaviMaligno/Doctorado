...
$m_3$, we obtain two concatenations of homotopies joining the composition $(f_1, f_2, f_3, f_4) \mapsto
...
The above equation will sometimes be referred to as the $A_\infty$-\emph{equation}. This seemingly obscure definition captures the idea of an algebra that is associative up to homotopy. The signs are related to the orientation given to the Stasheff polytopes. To see this, let us have a look at the first few cases.
...
(F(\OO(n))\otimes F(\OO(m)))\otimes F(\OO(l))\arrow[d, "\mu\otimes id"]\arrow[r, "a_\DD"]& F(\OO(n))\otimes (F(\OO(m))\otimes F(\OO(l)))\arrow[d, "id\otimes B_\DD"] \\
 ...
 F((\OO(n)\otimes\OO(m))\otimes \OO(l))\arrow[d, "F(\circ_i\otimes id)"]\arrow[rdd, dashed, "F(a_\CC)^{-1}\circ F(id\otimes B_\CC)\circ F(a_\CC)", sloped, bend right = 3] & (F(\OO(n))\otimes F(\OO(l)))\otimes F(\OO(m))\arrow[d, "\mu\otimes id"]\\
