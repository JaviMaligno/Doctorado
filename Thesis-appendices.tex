...
where
\begin{align*}
\varepsilon=&\binom{n}{2}+\binom{m}{2}+(n-1)(m-1)\\
...
&(1^{\otimes k_0}\otimes (S\circ g_1\circ (S^{-1})^{\otimes a_1})\otimes\cdots\otimes (S\circ g_n\circ (S^{-1})^{\otimes a_n})\otimes 1^{\otimes k_n}))\circ S^{\otimes N-n+\sum a_j}
\end{align*}
