...
\hline
$\mathrm{vbC}_R$ & Vertical bicomplexes & Maps of bigraded modules& As in $\bgmod$  \\
        (\cref{vbC})         &                      & that commute with differential & and usual differential\\ 
\hline
...
\hline
$\ufMod$ & Filtered modules & Bigraded module $\ufMod(K,L)$ & \\
& & & \\
\hline
$\ufC$ & Filtered complexes & Vertical bicomplex $\ufC(K,L)$ & \\
 & &  & \\
 \hline
