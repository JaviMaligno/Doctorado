...
\begin{exercise}
Consider the following graph. Apply the ToMATo algorithm choosing a suitable value of the merging parameter $\tau$. Draw the persistence diagram and subdivided into two regions corresponding to the division between clusters and noise.
\begin{figure}[h!]
\centering
\includegraphics[scale=0.7]{graphexercise}
\end{figure}
\end{exercise}
