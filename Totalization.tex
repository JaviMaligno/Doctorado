...
SAY SOMETHING ABOUT WHERE THE DEFINITIONS COME FROM, AND ADJUST TO CONVENTIONS, CHECK IF I NEED SOME RESULTS
...
This next tensor corresponds to $\underline{\otimes}$ in the categorical setup.
