...
\begin{propo}
Let $A=S\s\OO$ and let $x_1\otimes\cdots\otimes x_j\in (A^{\otimes j})^{n-k}_k$. Let $x_v = Sy_v$ for $v=1,\dots, j$ and let $y_v$ be of bidegree $(k_v,n_v-k_v)$. The following maps $M_{ij}$ determine a derived $A_\infty$-algebra structure on $A$.
...
EXPLAIN WHY WE START WITH THIS (THERE IS THIS STRUCTURE BY PREVIOUS ARTICLE AND THE FACT THAT M * M = 0)
