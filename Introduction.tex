...
VERY LIKELY TO MOVE THIS SECTION BEFORE THE SECTION ABOUT OPERADS SO I'LL WRITTE IT AS SUCH
...
I THINK FOR THIS I SHOULDN'T ASSUME THIS FAMILIARITY IN THE THESIS, SO PROBABLY ADD MORE DETAILS AND INTUITION
...
We will discuss these topics in the language of operads, which will  be introduced in the next CHAPTER? SECTION?
...
We will be working in the category of graded $R$-modules, but all the definitions and results in this section generalize with no substantial changes to any symmetric monoidal category like the ones we see in NEXT SECTION. 
...
\begin{defin}
The $\mathcal{A}_\infty$-operad is the non-symmetric operad whose algebras are $A_\infty$-algebras. WAS DEFINED BEFORE, SO REFERENCE Therefore, it is generated by elements $\mu_i\in\mathcal{A}_\infty(i)$ satisfying the operadic version of the $A_\infty$-equation.WRITE EXPLICITLY More details about this operad can be found in \cite[Chapter 9]{lodayvallette}.
\end{defin}
