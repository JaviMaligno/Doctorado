...
THE CONTENT OF SARAH'S PAPER COULD COME HERE

\subsection{Operads}
A BIT MORE OF WHAT IS IN JOIN, LIKE COOPERADS (THIS SHOULD ACTUALLY BE ADDED THERE) AND SOME OF THE STUFF IN THE ITEM BELOW (CHECK WHAT IS NECESSARY) AND THE LONG PROOF AT THE END OF THIS
\begin{itemize}
