...
We will be working in the category of graded $R$-modules, but all the definitions and results in this section generalize with no substantial changes to the bigraded case as well. MAYYBE ALSO MENTION OTHER CATEGORIES LIKE FILTERED MODULES (BUT I AM NOT SURE WHERE I AM GOING TO INTRODUCE THOSE YET)
