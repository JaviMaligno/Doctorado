...
for each $1\leq i\leq n$ satisfying natural unitality and associativity axioms. HERE WRITE DOWN THE ASSOCIATIVITY AXIOMS EXPLICITLY AND REFER TO WARD BECAUSE IT IS NOT THE STANDARD
...
ALGEBRAS OVER OPERADS, MORPHISMS BETWEEN ALGEBRAS
...
COOPERAD DEFINITION LODAY-VALLET 5.8.1 (INCLUDE THE MENTION TO THE OPPOSITE CATEGORY AND STUFF)
