...
Since we are working with $\Z$-graded modules, requiring that the map has degree 0 is redundant, but it is good to have that in mind for the calculations.
...
MORPHISMS OF ALGEBRAS OVER THE INFITY OPERAD ARE MORPHISM OF AINFTY. INFTYMORPHISM ALSO ARISE FROM OPERADS IN A DIFFERENT WAY, REFER TO LODAYVALLETTEE AND TO MY SECTION (SOMEWHAT SIMILAR BUT DIFFERENT IN APPROACH)
