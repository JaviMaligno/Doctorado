...
\begin{align*}
(x\cdot y)\cdot z=(-1)^{a(x)+q(x)-1+a(x)q(y)+a(x)+a(y)+q(x)+q(y)-1+a(x)q(z)+a(y)q(z)}m\{m\{x,y\},z\}=\\(-1)^{a(y)+q(y)+a(x)q(y)+a(x)q(z)+a(y)q(z)}m\{m\{x,y\},z\}
\end{align*}
and

\begin{align*}x\cdot (y\cdot z)=(-1)^{a(x)+q(x)-1+a(x)(q(y)+q(z))+a(y)+q(y)-1+a(y)q(z)}m\{x,m\{y,z\}\}=\\
(-1)^{a(x)+q(x)+a(x)q(y)+a(x)q(z)+a(y)+q(y)+a(y)q(z)}m\{x,m\{y,z\}\}
\end{align*}
...
$$d(d(x))=d(x\{m\}-(-1)^{a(x)+q(x)-1}m\{x\})=$$ 
$$m\{x\{m\}\}-(-1)^{q(x)}x\{m\}\{m\}-(-1)^{a(x)+q(x)-1}m\{m\{x\}\}+m\{x\}\{m\}$$




The second summand is 
$x\{m\}\{m\}=-x\{m,m\}+x\{m\{m\}\}+x\{m,m\}=0$.

The last summad is
$m\{x\}\{m\}=(-1)^{a(x)+q(x)-1}m\{m,x\}+m\{x\{m\}\}+m\{x,m\}$.
\end{proof}
\end{document}
