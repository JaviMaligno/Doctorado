...
For $f\in \End_A(n)$ let $|f|=\deg(f)+n-1$.\pause
\begin{lem}
...
\begin{itemize}
\item<1-> For $f=\sum_i f_i\in \Tot(C^n(A))$ and $g=\sum_i g_i\in \Tot(C^m(A))$ define %it has a reason but i'm not talking about operads
\begin{align*}
