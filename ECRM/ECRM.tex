...
\[\partial(m_3(a,b,c))=m_2(m_2(a,b), c)-m_2(a, m_2(b,c)).\]
\end{itemize}
...
\begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=1.0cm,y=1.0cm]
\clip(-1.3275591973205874,-0.38685809569094237) rectangle (9.456589431026222,4.804555737079);
...
\draw (2.2,4.8) node[anchor=north west] {$(a(bc))d$};
\draw (4.605831960418,3.3) node[anchor=north west] {$((ab)c)d$};
\draw (-0.287131707673,3.3) node[anchor=north west] {$(ab)(cd)$};
\draw (0.3,1.1) node[anchor=north west] {$a(b(cd))$};
\draw (4.0835012940154,1.1) node[anchor=north west] {$a((bc)d)$};
\draw<2-> (3.,2.)-- (3.,2.5);
...
\draw<3-> [->] (3.,4.077683537175253) -- (3.895997820398156,3.4267030156558835);
\draw<3-> [->] (4.618033988749895,2.9021130325903064) -- (4.263241770003597,1.8101748618369442);
\draw<3-> [->] (4.,1.) -- (2.8910762923835747,1.);
\draw<3-> [->] (3.,4.077683537175253) -- (2.1179720645146554,3.4368527311563817);
\draw<3-> [->] (1.3819660112501053,2.9021130325903073) -- (1.7339911627499194,1.8186910191477048);
\draw<4-> [shift={(3.0017933711466016,3.376812542996852)}] plot[domain=-4.688583954199619:0.02083032003621599,variable=\t]({1.*0.27361383422126806*cos(\t r)+0.*0.27361383422126806*sin(\t r)},{0.*0.27361383422126806*cos(\t r)+1.*0.27361383422126806*sin(\t r)});
\draw<4-> [->] (3.,3.65) -- (3.15,3.65);
\begin{scriptsize}
