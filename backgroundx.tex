...
An algebra over an operad $\OO$ is a map of operads $\OO\to\End_A$. By adjunction, this is equivalent to a collection of maps $\OO(n)\otimes A^{\otimes n}\to A$ for each $\geq 0$.  
\end{defin}
