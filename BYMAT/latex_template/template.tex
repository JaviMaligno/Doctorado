\TITLE{Induced $A_\infty$-structure on the Hochschild complex of an $A_\infty$-algebra} % The title of your talk. Use capital letters only for the first word and names.
...
for all possible values of $n$. When $m_i=0$ for $i\neq 2$, this relation tells us that %$m_2$ is an associative product, so associative algebras are a particular case of $A_\infty$-algebras.
