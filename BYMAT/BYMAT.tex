...
\begin{align*}
&m_2(m_1\otimes 1)-m_2(1\otimes m_2)=\\ %the failure of m_2 to be associative
...
\item<2-> Let $X$ be the Moore space with one nonvanishing homology group $Q^p$ in dimension $2n-1$. %For some n I guess
