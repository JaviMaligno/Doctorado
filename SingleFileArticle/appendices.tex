...
\end{align}
We want this terms to add up to something of the form $b_1(b_1(m;m);x)$. Notice that for this we need to switch some pairs. For simplicity, we switch the pair of the first term and rewrite the sum as
\begin{align}
