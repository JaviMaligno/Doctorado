...
\frametitle{Braces}
\begin{itemize}
\item For $x\in\mathfrak{s}\mathcal{O}(n)$ and $j\leq n$, define maps called \textbf{braces}
\[b_j(x;x_1,\dots,x_j)=\sum \gamma(x;1,\dots, 1,x_1,1,\dots,1,x_j,1,\dots, 1)\]\pause %the sum runs over all order preserving insertions

PICTURE 
\pause

\item Observe that $b_1(a;b)=a\tilde{\circ} b$. 
