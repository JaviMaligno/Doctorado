...
\begin{proof}
Write $j_n$ for the arity %(degree? the definition of brace is in graded things, not things with arity, but in the hochschild complex the degree is given by the arity) 
of $x_n$. 
