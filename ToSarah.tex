...
The operadic suspension defined here is a slight modification of the one found in WARD 
...
where the sum runs over all possible ordering preserving insertions. The brace $b_n(f;g_1,\dots,g_n)$ vanishes whenever $n>N$.
