...
%--------------------------------------------------------
\begin{document}
\title{\bf{The derived Deligne conjecture}\\ \vspace{2cm}}
...
\date{\emph{A thesis submitted to fulfil the requirements for the degree of Doctor of Philosophy in Mathematics}\\ [\baselineskip] School of Mathematics, Statistics and Actuarial Sciences\\ University of Kent\\ [\baselineskip] \today}
