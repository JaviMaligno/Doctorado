...
UNDERLINED HOM & FROM 2.4.4  \\

$\mathrm{tC}_R$ & Twisted complexes \\



$\underline{\mathpzc{bgMod}_R}$ & $\mathrm{bgMod}_R$-enriched category of bigraded modules \\

$\underline{t\mathcal{C}_R}$& $\mathrm{vbC}_R$-enriched category of twisted complexes\\


$\ufMod$ & $\mathrm{bgMod}_R$-enriched category of filtered modules \\

$\ufC$ & $\mathrm{vbC}_R$-enriched category of filtered complexes \\

BOUNDED VERSIONS? & I ONLY USE THE NOTATION LIKE ONCE \\
TENSOR PRODUCTS & ENRICHED TOO\\
TOT & \\
DEGREES & INCLUDING DEG\\
SHIFT & VERTICAL FOR BIGRADED\\
OPERADIC SUSPENSION & AS A MODULE AS WELL\\
BAR SIGMA & THE ISO\\
BRACES & (BI)GRADED AND TOTALIZED, AND CAPITAL\\
INTEGERS? & AS A GROUP\\
OPERADIC COMP & SOMETIMES USED AS AN EXPONENT, TILDE ON SUSP, BAR ON TOT\\
INSERTIONS & THE OTHER VERSIONS TOO\\
AINFTY OPERAD & A COUPLE OF CATEGORIES\\
DAINFTY OPERAD & A COUPLE OF CATEGORIES TOO\\
END & THERE ARE SEVERAL VERSIONS (UNDERLINED AND COLLECTION TOO)\\
AINFTY AND DAINFTY MAPS & IN ALL VERSIONS\\
PHI & ISOM\\
MU? & MONOIDAL\\
\end{tabular}
