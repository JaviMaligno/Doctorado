...
As we mentioned in \Cref{boundednessremark}, this condition is satisfied in all known examples of derived $A_\infty$-algebras \cite[Remark 6.5]{muro}, \cite{RW}, and \cite[\S 5]{women}. These examples usually come as minimal models of dga's. So a first question that arises is the following.
...
\end{question}
Notice that the above question includes the Hochschild cohomology of $A_\infty$-algebras, since this is the same as the vertical cohomology of an $A_\infty$-algebra sitting on horizontal degree 0. 
